    ...
    return(
        <Layout>
            ...
            <label>{editedCategory
                    ? `Editar a categoria = "${editedCategory.name}"`
            ...
            <form onSubmit={saveCategory} className="flex gap-1">
                ...
                >
                    <option value="">Não é uma Sub-Categoria</option>
                ...
                <tbody>
                    ...
                    {categories.length > 0 && categories.map(categories => (
                        <tr key={categories._id}>
                            ...
                            <td>
                            <Link href="#" onClick={() => editCategory(categories)}>
                                ...
                                <Link href="#" onClick={() => deleteCategory(categories)} >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
